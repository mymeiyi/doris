...
public class MetaServiceOverloadThrottleTest {
    ...
    public void setUp() {
        ...
        originalThrottleMethods = Config.meta_service_rpc_overload_throttle_method_allowlist;
    ...
    public void tearDown() {
        ...
        Config.meta_service_rpc_overload_throttle_method_allowlist = originalThrottleMethods;
    ...
    public void testBackpressureTriggersDecrease() {
        ...
        for (int i = 0; i < 2; i++) {
            throttle.recordSignal(MetaServiceOverloadThrottle.Signal.BACKPRESSURE);
        }
        Assert.assertEquals(7, throttle.getWindowTotal());
        Assert.assertEquals(2, throttle.getWindowBad());
        throttle.recordSignal(MetaServiceOverloadThrottle.Signal.TIMEOUT);
