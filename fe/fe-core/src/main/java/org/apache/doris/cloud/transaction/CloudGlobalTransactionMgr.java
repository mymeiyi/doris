...
public class CloudGlobalTransactionMgr implements GlobalTransactionMgrIface {
    ...
    public void afterCommitTxnResp(CommitTxnResponse commitTxnResponse) {
        ...
        Map<CloudPartition, Pair<Long, Long>> parititionVersionMap = new HashMap<>();
        ...
        for (int idx = 0; idx < totalPartitionNum; ++idx) {
            ...
            parititionVersionMap.put(partition, Pair.of(version, commitTxnResponse.getVersionUpdateTimeMs()));
        ...
        for (int i = 0; i < commitTxnResponse.getTablesList().size(); i++) {
            ...
            tableVersions.add(Pair.of(olapTable, commitTxnResponse.getTableVersionsList().get(i)));
        }
