...
Status NewOlapScanner::_init_tablet_reader_params(
    ...
    // _tablet_reader_params.direct_mode = false;
    /*LOG(INFO) << "sout: "
              << ", skip_storage_engine_merge=" << _state->skip_storage_engine_merge()
              << ", direct_mode=" << _tablet_reader_params.direct_mode
              << ", aggregation=" << _tablet_reader_params.aggregation
              << ", single_version=" << single_version
              << ", tablet_id=" << _tablet_reader_params.tablet->tablet_id();*/
