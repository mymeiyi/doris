...
private:
    ...
    Status complete_prepared_compaction(bool build_output_rowset);
...
private:
    ...
    std::shared_ptr<cloud::DistributedCompaction> _distributed_compaction;
    ...
    std::chrono::steady_clock::time_point _async_execution_start_time;
