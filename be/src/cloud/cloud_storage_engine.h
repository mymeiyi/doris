...
public:
    ...
    ThreadPool& distributed_compaction_thread_pool() const {
        return *_distributed_compaction_thread_pool;
    }
...
private:
    ...
    std::unique_ptr<ThreadPool> _distributed_compaction_thread_pool;
