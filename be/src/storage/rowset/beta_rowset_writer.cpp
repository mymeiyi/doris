...
Status BetaRowsetWriter::_close_file_writers() {
    ...
    // A partial output writer owns only one segment-id slot of a coordinator-assembled rowset.
    // Writer-local segment compaction could move files outside that slot.
