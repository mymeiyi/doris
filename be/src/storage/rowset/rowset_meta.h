...
public:
    ...
    // 2. The rowset has a singleton version. Multi-version rowsets are regular compaction outputs
    //    whose segments are globally non-overlapping.
    // 3. segments_overlap() is not NONOVERLAPPING (OVERLAP_UNKNOWN, OVERLAPPING, and
