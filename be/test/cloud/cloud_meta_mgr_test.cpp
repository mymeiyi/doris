...
TEST_F(CloudMetaMgrTest, PreRowsetDeleteBitmapStatsRequestEncoding) {
    ...
    bool old_remove_by_keys = config::enable_remove_pre_rowsets_delete_bitmap_by_keys;
    ...
    Defer cleanup {[&] {
        ...
        config::enable_remove_pre_rowsets_delete_bitmap_by_keys = old_remove_by_keys;
    ...
    config::enable_remove_pre_rowsets_delete_bitmap_by_keys = false;
