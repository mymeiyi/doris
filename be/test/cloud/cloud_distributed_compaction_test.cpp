...
TEST(CloudDistributedCompactionTest, chooses_weighted_short_key_boundaries) {
    EXPECT_TRUE(cloud::is_supported_key_range_column_type(
            FieldType::OLAP_FIELD_TYPE_TINYINT));
    EXPECT_TRUE(cloud::is_supported_key_range_column_type(
            FieldType::OLAP_FIELD_TYPE_SMALLINT));
    EXPECT_TRUE(
            cloud::is_supported_key_range_column_type(FieldType::OLAP_FIELD_TYPE_INT));
    EXPECT_TRUE(cloud::is_supported_key_range_column_type(
            FieldType::OLAP_FIELD_TYPE_BIGINT));
    EXPECT_TRUE(cloud::is_supported_key_range_column_type(
            FieldType::OLAP_FIELD_TYPE_LARGEINT));
    EXPECT_TRUE(
            cloud::is_supported_key_range_column_type(FieldType::OLAP_FIELD_TYPE_CHAR));
    EXPECT_TRUE(cloud::is_supported_key_range_column_type(
            FieldType::OLAP_FIELD_TYPE_VARCHAR));
    EXPECT_TRUE(
            cloud::is_supported_key_range_column_type(FieldType::OLAP_FIELD_TYPE_DATE));
    EXPECT_TRUE(cloud::is_supported_key_range_column_type(
            FieldType::OLAP_FIELD_TYPE_DATETIME));
    EXPECT_TRUE(
            cloud::is_supported_key_range_column_type(FieldType::OLAP_FIELD_TYPE_DATEV2));
    EXPECT_TRUE(cloud::is_supported_key_range_column_type(
            FieldType::OLAP_FIELD_TYPE_DATETIMEV2));
    EXPECT_TRUE(
            cloud::is_supported_key_range_column_type(FieldType::OLAP_FIELD_TYPE_DECIMAL));
    EXPECT_TRUE(
            cloud::is_supported_key_range_column_type(FieldType::OLAP_FIELD_TYPE_DECIMAL32));
    EXPECT_TRUE(
            cloud::is_supported_key_range_column_type(FieldType::OLAP_FIELD_TYPE_DECIMAL64));
    EXPECT_TRUE(cloud::is_supported_key_range_column_type(
            FieldType::OLAP_FIELD_TYPE_DECIMAL128I));
    EXPECT_TRUE(
            cloud::is_supported_key_range_column_type(FieldType::OLAP_FIELD_TYPE_DECIMAL256));
    EXPECT_FALSE(cloud::is_supported_key_range_column_type(
