...
TEST(RecyclerTest, delete_v2_inverted_index_with_segment_list) {
    ...
    auto rowset =
            create_rowset(std::string(resource_id), 10002, 10001, num_segments, schema);
    for (auto segment_id : segment_ids) {
        ...
        ASSERT_EQ(accessor->put_file(
                  ...
                  0);
        ASSERT_EQ(accessor->put_file(
                          inverted_index_path_v2(rowset.tablet_id(), rowset.rowset_id_v2(),
                                                 segment_id),
                          ""),
                  0);
    }
    ...
    for (auto segment_id : segment_ids) {
        EXPECT_EQ(accessor->exists(
                          segment_path(rowset.tablet_id(), rowset.rowset_id_v2(), segment_id)),
                  1);
        EXPECT_EQ(accessor->exists(inverted_index_path_v2(
                          rowset.tablet_id(), rowset.rowset_id_v2(), segment_id)),
                  1);
    }

    auto batch_rowset =
            create_rowset(std::string(resource_id), 10003, 10001, num_segments, schema);
    for (auto segment_id : segment_ids) {
        ...
        ASSERT_EQ(accessor->put_file(segment_path(batch_rowset.tablet_id(),
                                     ...
                                     ""),
                  0);
        ASSERT_EQ(accessor->put_file(inverted_index_path_v2(
                                             batch_rowset.tablet_id(),
                                             batch_rowset.rowset_id_v2(), segment_id),
                                     ""),
                  0);
    }
    ...
    for (auto segment_id : segment_ids) {
        EXPECT_EQ(accessor->exists(segment_path(batch_rowset.tablet_id(),
                  ...
                  1);
        EXPECT_EQ(accessor->exists(inverted_index_path_v2(
                          batch_rowset.tablet_id(), batch_rowset.rowset_id_v2(), segment_id)),
                  1);
    }
}
